    ...
    <DashboardLayout allowedRoles={["KASIR", "OWNER"]}>
      <div className="page-content">
        <div className="page-header">
          <div>
            <Link href="/kasir/order" className={styles.backLink}>
              ← Kembali
            </Link>
        ...
        <div className={styles.layout}>
          ...
          <div className={styles.mainCol}>
            ...
            <div className="card">
              ...
              <div className={styles.infoGrid}>
                ...
                <div className={styles.infoItem}>
                  ...
                  <span
                    className={`badge ${order.paymentStatus === "SUDAH_BAYAR" ? "badge-success" : "badge-warning"}`}
                  >
            ...
            <div className="card mt-6">
                    ...
                    {order.items.map((item) => (
                      <tr key={item.id}>
                        ...
                        <td>
                          ...
                          {item.service.type === "KILOAN" ? "kg" : "pcs"}
                        </td>
              ...
              {/* Mobile Item Cards */}
              <div className={styles.mobileItemCards}>
                {order.items.map((item) => (
                  <div key={item.id} className={styles.itemCard}>
                    ...
                    <div className={styles.itemDetails}>
                      <span>
                        {parseFloat(item.quantity)}{" "}
                        {item.service.type === "KILOAN" ? "kg" : "pcs"} x{" "}
                ...
                <div className={styles.timeline}>
                  {order.statusHistory.map((history, index) => (
                    <div key={history.id} className={styles.timelineItem}>
                      <div
                        className={`${styles.timelineDot} ${index === 0 ? styles.active : ""}`}
                      ></div>
                      <div className={styles.timelineContent}>
                        <span
                          className={`status-badge ${getStatusClass(history.status)}`}
                        >
              ...
              <div className="modal-body">
                <div className={styles.receipt} id="printable-receipt">
                  ...
                  <div className={styles.receiptStatus}>
                    ...
                    <span>
                      Bayar: {getPaymentStatusLabel(order.paymentStatus)}
                    </span>
                  </div>
