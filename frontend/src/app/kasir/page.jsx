          ...
          {data?.pendingOrders?.length > 0 ? (
                  ...
                  <div key={order.id} className={styles.orderCard}>
                    ...
                    <div className={styles.cardBody}>
                      <div className={styles.cardRow}>
                        <span className={styles.cardLabel}>Pelanggan</span>
                      ...
                      <div className={styles.cardRow}>
                        <span className={styles.cardLabel}>Waktu</span>
                        <div className={styles.cardValue}>
                          {formatDateTime(order.createdAt)}
                        </div>
                      </div>
                      ...
                      <div className={styles.cardRow}>
                        <span className={styles.cardLabel}>Pembayaran</span>
                        <div className={styles.cardValue}>
                          <span
                            className={`badge ${order.paymentStatus === "SUDAH_BAYAR" ? "badge-success" : "badge-warning"}`}
                          >
            ...
            <div className="empty-state">
              ...
              <div className="empty-state-description">
                Semua order sudah selesai diproses
              </div>
            </div>
          )}
        </div>
                ...
                {data.recentOrders.map((order) => (
                  <div key={order.id} className={styles.orderCard}>
                    ...
                    <div className={styles.cardBody}>
                      ...
                      <div className={styles.cardRow}>
                        <span className={styles.cardLabel}>Layanan</span>
                        <div className={styles.cardValue}>
