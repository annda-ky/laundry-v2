        ...
        <div className="card">
              ...
              <tbody>
                {users.map((user) => (
                  ...
                  >
                    ...
                    <td>
                      <span
                        className={`badge ${user.role === "OWNER" ? "badge-primary" : "badge-secondary"}`}
                      >
          ...
          <div className={styles.mobileCards}>
            {users.map((user) => (
              <div
                key={user.id}
                className={`${styles.userCard} ${!user.isActive ? styles.inactive : ""}`}
              >
                <div className={styles.cardHeader}>
                  <span className={styles.cardTitle}>{user.username}</span>
                  <span
                    className={`badge ${user.isActive ? "badge-success" : "badge-danger"}`}
                  >
                    {user.isActive ? "Aktif" : "Nonaktif"}
